...
import id.co.ikonsultan.approval.feature.home.databinding.FragmentSearchBinding
...
class SearchFragment :
    BaseFragment<FragmentSearchBinding, HomeState, HomeEvent, HomeEffect, HomeViewModel>(R.layout.fragment_search) {
