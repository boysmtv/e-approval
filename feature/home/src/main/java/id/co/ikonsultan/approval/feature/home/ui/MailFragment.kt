...
import id.co.ikonsultan.approval.feature.home.databinding.FragmentMailBinding
...
@AndroidEntryPoint
class MailFragment :
    BaseFragment<FragmentMailBinding, HomeState, HomeEvent, HomeEffect, HomeViewModel>(R.layout.fragment_mail) {
